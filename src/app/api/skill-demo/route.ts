...
async function runTranslatorDemo() {
  return {
    ...
    timestamp: new Date().toISOString(),
    data: {
      originalText: "Peru Hub es la primera tienda de herramientas para agentes de inteligencia artificial.",
      detectedLanguage: "Español (es-PE)",
      translations: [
        { lang: "English", flag: "🇺🇸", text: "Peru Hub is the first tool store for artificial intelligence agents." },
        { lang: "Português", flag: "🇧🇷", text: "Peru Hub é a primeira loja de ferramentas para agentes de inteligência artificial." },
        { lang: "Français", flag: "🇫🇷", text: "Peru Hub est le premier magasin d'outils pour agents d'intelligence artificielle." },
        { lang: "Deutsch", flag: "🇩🇪", text: "Peru Hub ist der erste Werkzeugladen für Agenten künstlicher Intelligenz." },
        { lang: "日本語", flag: "🇯🇵", text: "Peru Hubは人工知能エージェントのための最初のツールストアです。" },
      ],
